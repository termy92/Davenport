...
public class JDBMaterialUomTableModel extends AbstractTableModel {
	...
	private final String[] mcolNames = { "Material", "UOM", "EAN", "Variant", "Numerator", "Denominator" };
	private ResultSet mResultSet;

	private int prowCount = -1;
	private final HashMap<Integer, JDBMaterialUom> cache = new HashMap<Integer, JDBMaterialUom>();
