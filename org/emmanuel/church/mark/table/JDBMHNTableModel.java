...
import org.emmanuel.church.mark.db.JDBMHN;
...
public class JDBMHNTableModel extends AbstractTableModel {
	...
	public static final int date_created_Col = 6;
	public static final int date_expected_Col = 7;
	public static final int date_resolved_Col = 8;
	public static final int status_Col = 9;
	public static final int resource_Col = 10;
	public static final int comment_Col = 11;

	private final String[] mcolNames = { "MHN Number", "Recorder", "Initiator", "Reason 1", "Reason 2", "Reason 3",
			"Date Created", "Date Expected", "Date Resolved", "Status", "Resource", "Comment" };
	private ResultSet mResultSet;
	private int prowCount = -1;
	private final HashMap<Integer, JDBMHN> cache = new HashMap<Integer, JDBMHN>();
