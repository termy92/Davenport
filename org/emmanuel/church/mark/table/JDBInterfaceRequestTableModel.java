...
public class JDBInterfaceRequestTableModel extends AbstractTableModel {
	...
	private final String[] mcolNames = { "Event Time", "Request ID", "Interface Type", "Workstation",
			"Transaction Ref", "Status", "Mode", "Filaneme" };
	private ResultSet mResultSet;
	private int prowCount = -1;

	// private final HashMap<Integer, JDBInterfaceRequest> cache = new
	// HashMap<Integer, JDBInterfaceRequest>();
	...
	public Object getValueAt(int row, int col) {
		...
		// final JDBInterfaceRequest prow = new
		// JDBInterfaceRequest(Common.selectedHostID, Common.sessionID);
