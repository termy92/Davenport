...
import org.emmanuel.church.mark.db.JDBLocation;
...
public class JDBLocationTableModel extends AbstractTableModel {
	...
	public static final int Location_Plant_Col = 1;
	public static final int Location_Warehouse_Col = 2;
	public static final int Location_GLN_Col = 3;
	public static final int Location_Description_Col = 4;
	public static final int Location_Storage_Location_Col = 5;
	public static final int Location_Storage_Type_Col = 6;
	public static final int Location_Storage_Section_Col = 7;
	public static final int Location_Storage_Bin_Col = 8;

	// Names of the columns
	private final String[] mcolNames = { "Location ID", "Plant", "Warehouse", "GLN", "Description", "Storage Location",
			"Storage Type", "Storage Section", "Storage Bin" };
	// Types of the columns.
	private ResultSet mResultSet;

	private int prowCount = -1;
	private final HashMap<Integer, JDBLocation> cache = new HashMap<Integer, JDBLocation>();
