...
public class JDBInterfaceLogTableModel extends AbstractTableModel {
	...
	public static final int filename_id_Col = 8;
	public static final int message_date_Col = 9;
	public static final int message_error_Col = 10;
	public static final int workstation_id_Col = 11;

	private final String[] mcolNames = { "Log ID", "Event Time", "Interface Type", "Message Ref", "Message Info",
			"Direction", "Action", "Status", "Filename" };
	private ResultSet mResultSet;
	private int prowCount = -1;

	// private final HashMap<Integer, JDBInterfaceLog> cache = new
	// HashMap<Integer, JDBInterfaceLog>();
	...
	public Object getValueAt(int row, int col) {
		...
		// final JDBInterfaceLog prow = new
		// JDBInterfaceLog(Common.selectedHostID, Common.sessionID);
