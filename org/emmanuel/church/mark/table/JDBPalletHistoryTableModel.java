...
import org.emmanuel.church.mark.db.JDBPalletHistory;
...
public class JDBPalletHistoryTableModel extends AbstractTableModel {
	...
	private final String[] mcolNames = { "Ref", "Type", "Subtype", "Date", "SSCC", "Material", "Batch",
			"Process Order", "Quantity", "UOM", "Despatch No", "Status", "Location", "User ID", "MHN Number",
			"Decision", "SSCC Expiry" };
	...
	private final HashMap<Integer, JDBPalletHistory> cache = new HashMap<Integer, JDBPalletHistory>();
