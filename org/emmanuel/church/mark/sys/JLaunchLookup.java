...
public class JLaunchLookup {
	...
	public static boolean processOrders() {
		// String schemaName =
		// Common.hostList.getHost(Common.selectedHostID).getDatabaseParameters()
		// .getjdbcDatabaseSchema();
		// JDialogLookup.dlg_table = new JDBTable(Common.selectedHostID,
		// Common.sessionID, JUtility.substSchemaName(
		// schemaName, "{schema}app_process_order"));
	...
	public static boolean locations() {
		...
		// JDialogLookup.dlg_table = new JDBTable(Common.selectedHostID,
		// Common.sessionID, JUtility.substSchemaName(
		// schemaName, "{schema}app_location"));
	...
	public static boolean reasons() {
		...
		// JDialogLookup.dlg_table = new JDBTable(Common.selectedHostID,
		// Common.sessionID, JUtility.substSchemaName(
		// schemaName, "{schema}app_mhn_reasons"));
	...
	public static boolean customers() {
		...
		// JDialogLookup.dlg_table = new JDBTable(Common.selectedHostID,
		// Common.sessionID, JUtility.substSchemaName(
		// schemaName, "{schema}app_customer"));
	...
	public static boolean materials() {
		...
		// JDialogLookup.dlg_table = new JDBTable(Common.selectedHostID,
		// Common.sessionID, JUtility.substSchemaName(
		// schemaName, "{schema}app_material"));
	...
	public static boolean materialBatches() {
		...
		// JDialogLookup.dlg_table = new JDBTable(Common.selectedHostID,
		// Common.sessionID, JUtility.substSchemaName(
		// schemaName, "{schema}app_material_batch"));
