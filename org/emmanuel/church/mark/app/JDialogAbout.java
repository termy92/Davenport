...
public class JDialogAbout extends javax.swing.JDialog {
	...
	private final JDBLanguage xlate = new JDBLanguage(Common.selectedHostID, Common.sessionID);
		...
		try {
			{
				...
				this.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
				{
					...
					jDesktopPane1.setBounds(0, 0, 350, 237);
					this.getContentPane().add(jDesktopPane1);
					jDesktopPane1.setPreferredSize(new java.awt.Dimension(350, 231));
					jDesktopPane1.setLayout(null);
					{
						jButtonOk = new JButton(Common.icon_ok);
						jDesktopPane1.add(jButtonOk);
						jButtonOk.setText(xlate.get("btn_Ok"));
						jButtonOk.setMnemonic(xlate.getMnemonicChar());
						jButtonOk.setFont(Common.font_btn);
							...
							public void mouseClicked(MouseEvent evt) {
								if (HelpAvailable) {
									try {
										...
										JUtility.errorBeep();
										JOptionPane.showMessageDialog(Common.mainForm, ex.getMessage(), "Error",
					...
					{
						// String msg =
						// "4001234567890123456789012345678901234567890";
						// i = JEANImage.getAWTImage("xml/barcode/about.xml",
						// msg);
						// Graphics gph = i.getGraphics();
						// jDesktopPane1.paintComponents(gph.create(0, 0, 200,
						// 50));
					}
					{
						jLabel5 = new JLabel();
