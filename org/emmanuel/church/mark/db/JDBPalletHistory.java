...
public class JDBPalletHistory {
	...
	public JDBPalletHistory(long transactionRef, String transactionType, String transactionSubtype,
			Timestamp transactionDate, JDBPallet pallet, String userId) {
		clear();
	...
	public ResultSet getInterfacingData(Long transactionRef, String transactionType, String transactionSubtype,
			Long maxRecords, String sortBy, String ascDesc) {
		...
		// temp =
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBPalletHistory.selectWithExpiry");
		//
		// if (maxRecords > 0) {
		// if
		// (Common.hostList.getHost(getHostID()).getDatabaseParameters().getjdbcDatabaseSelectLimit().equals("top"))
		// {
		// temp = temp.replace("[top]", "top " + String.valueOf(maxRecords));
		// }
		// }
		...
		// if (maxRecords > 0) {
		// if
		// (Common.hostList.getHost(getHostID()).getDatabaseParameters().getjdbcDatabaseSelectLimit()
		// .equals("rownum")) {
		// query.addParamtoSQL("rownum<=", String.valueOf(maxRecords));
		// }
		// }

		ad = ascDesc;

		query.addText(" order by " + sortBy + " " + ad);

		// if (maxRecords > 0) {
		// if
		// (Common.hostList.getHost(getHostID()).getDatabaseParameters().getjdbcDatabaseSelectLimit()
		// .equals("limit")) {
		// query.addText(" limit " + String.valueOf(maxRecords));
		// }
		// }
	...
	public boolean write() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBPalletHistory.write"));
