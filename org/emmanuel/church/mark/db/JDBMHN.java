...
public class JDBMHN {
	...
	public JDBMHN(String MHNNumber, String initiator, String recorder, String authorisor, String reason1,
			String reason2, String reason3, Timestamp created, Timestamp expected, Timestamp resolved, String status,
			String comment, String resource, Integer count) {
	...
	public boolean create() {
		...
		// .prepareStatement(Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHN.create"));
	...
	public boolean delete() {
		...
		// stmtupdate =
		// Common.hostList.getHost(getHostID()).getConnection(getSessionID())
		// .prepareStatement(Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHN.delete"));
		// stmtupdate.setString(1, getMHNNumber());
		// stmtupdate.execute();
		// stmtupdate.clearParameters();
		// Common.hostList.getHost(getHostID()).getConnection(getSessionID()).commit();
	...
	public boolean getMHNProperties() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHN.getMHNProperties"));
		// stmt.setFetchSize(1);
	...
	public LinkedList<String> getPalletsAssigned() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBPallet.assignedToMHN"));
		// stmt.setFetchSize(1);
		// stmt.setString(1, getMHNNumber());
		// rs = stmt.executeQuery();
		//
	...
	public LinkedList<String> getPalletDecisionSummmary() {
		...
		// .getSQL("JDBMHN.palletDecisionSummary"));
		// stmt.setFetchSize(1);
		// stmt.setString(1, getMHNNumber());
		// rs = stmt.executeQuery();
		//
		...
		// " ")
		// +
		// JUtility.padString(String.valueOf(rs.getBigDecimal("sum_quantity")),
		// false, 12, " ")
		// + "   ( " +
	...
	public boolean isValidMHN() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHN.isValidMHN"));
		// stmt.setString(1, getMHNNumber());
		// stmt.setFetchSize(1);
		// rs = stmt.executeQuery();
		//
	...
	public boolean update() {
		...
		// stmtupdate =
		// Common.hostList.getHost(getHostID()).getConnection(getSessionID())
		// .prepareStatement(Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHN.update"));
		//
