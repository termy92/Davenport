...
import org.emmanuel.church.mark.ui.GenericMessageHeader;
...
public class JDBInterfaceRequest {
	...
	public boolean update() {
		...
		// .getSQL("JDBInterfaceRequest.update"));
	...
	public boolean create() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBInterfaceRequest.create"));
	...
	public boolean delete() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBInterfaceRequest.delete"));
	...
	public LinkedList<Long> getInterfaceRequestIDs() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBInterfaceRequest.getInterfaceRequestIDs"));
	...
	public boolean getInterfaceRequestProperties() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBInterfaceRequest.getInterfaceRequestProperties"));
		...
		// result = true;
		// } else {
		// setErrorMessage("Invalid Interface Request ID [" +
		// getInterfaceRequestID() + "]");
		// }
		// rs.close();
		// stmt.close();
		// } catch (SQLException e) {
