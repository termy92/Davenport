...
public class JDBUom {
	...
	public boolean create(String luom, String liso_uom, String loc_uom, String ldescription) {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.create"));
	...
	public boolean delete() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.delete"));
		// stmtupdate.setString(1, getInternalUom());
		// stmtupdate.execute();
		// stmtupdate.clearParameters();
		// Common.hostList.getHost(getHostID()).getConnection(getSessionID()).commit();
	...
	public boolean getISOUomProperties() {
		...
		// .getSQL("JDBUom.getISOUomProperties"));
	...
	public boolean getLocalUomProperties() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBUom.getLocalUomProperties"));
	...
	public ResultSet getUomDataResultSet() {
		...
		// .prepareStatement(Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.getUoms"));
	...
	public boolean getInternalUomProperties() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.getUomProperties"));
	...
	public boolean isValidInternalUom() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.isValidUom"));
		// stmt.setString(1, getInternalUom());
		// stmt.setFetchSize(1);
		// rs = stmt.executeQuery();
		//
	...
	public boolean renameInternalUomTo(String newUom) {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.renameTo"));
	...
	public boolean update() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBUom.update"));
