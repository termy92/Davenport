...
public class JDBMHNDecisions {
	...
	public LinkedList<JDBMHNDecisions> getMHNDecisions() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHN.getDecisions"));
		// stmt.setFetchSize(250);
		// rs = stmt.executeQuery();
		//
		// while (rs.next()) {
		// JDBMHNDecisions descision = new JDBMHNDecisions(getHostID(),
		// getSessionID());
	...
	public boolean create(String decision, String description, String status) {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHNDecision.create"));
	...
	public boolean update() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHNDecision.update"));
	...
	public boolean delete() {
		...
		// .getConnection(getSessionID())
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements().getSQL("JDBMHNDecision.delete"));
		// stmtupdate.setString(1, getDecision());
		// stmtupdate.execute();
		// stmtupdate.clearParameters();
		// Common.hostList.getHost(getHostID()).getConnection(getSessionID()).commit();
	...
	public boolean renameTo(String newDecision) {
		...
		// try {
		// if (isValidDecision() == true) {
		// JDBMHNDecisions mattype = new JDBMHNDecisions(getHostID(),
		// getSessionID());
		...
		// .getSQL("JDBMHNDecision.renameTo"));
	...
	public boolean isValidDecision() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMHNDecision.isValidDecision"));
	...
	public boolean getDecisionProperties() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMHNDecision.getDecisionProperties"));
		// stmt.setString(1, getDecision());
		// stmt.setFetchSize(1);
		// rs = stmt.executeQuery();
		//
	...
	public HashMap<String, JColorPair> getDecisionColors() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMHNDecision.getDecisions"));
	...
	public Vector<JDBMHNDecisions> getDecisions() {
		...
		//
		// while (rs.next()) {
		// JDBMHNDecisions mt = new JDBMHNDecisions(getHostID(),
		// getSessionID());
	...
	public String toString() {
		...
		if (getDecision().equals("") == false) {
			result = JUtility.padString(getDecision(), true, field_decision, " ") + " - "
					+ JUtility.padString(getStatus(), true, field_status, " ") + " - " + getDescription();
		} else {
			result = "";
		}
