...
public class JDBMaterialLocation {
	...
	public boolean getMaterialLocationProperties() {
		...
		// .getSQL("JDBMaterialLocation.getProperties"));
	...
	public boolean create(String material, String location) {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMaterialLocation.create"));
		...
		// result = true;
		// } else {
		// setErrorMessage("Material " + getMaterial() + " Location " +
		// getLocation() + " already exists");
		// }
		// } catch (SQLException e) {
		// setErrorMessage(e.getMessage());
		// }
	...
	public boolean delete() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMaterialLocation.delete"));
		// stmtupdate.setString(1, getMaterial());
		// stmtupdate.setString(2, getLocation());
		// stmtupdate.execute();
		// stmtupdate.clearParameters();
	...
	public boolean isValidMaterialLocation() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMaterialLocation.isValidMaterialLocation"));
		// stmt.setFetchSize(1);
		// stmt.setString(1, getMaterial());
		// stmt.setString(2, getLocation());
		// rs = stmt.executeQuery();
	...
	public boolean update() {
		...
		// .prepareStatement(
		// Common.hostList.getHost(getHostID()).getSqlstatements()
		// .getSQL("JDBMaterialLocation.update"));
